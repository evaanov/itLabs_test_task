    ...
    <div class="add_user">
      <div class="form">
        <form @submit.prevent>
          ...
          <div>
            <p>Присутствие</p>
            <input type="checkbox" v-model="post.isHere">
          </div>
          <div>
            <button @click="createUser" v-if="this.post.name === '' || this.post.company === '' || this.post.group === ''" disabled>Добавить</button>
            <button @click="createUser" v-else>Добавить</button>
